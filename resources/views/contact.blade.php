...
<div class="min-h-full">
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Welcome To Your Public Profile</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
  ...
  <section class="bg-blue-600 text-white py-16 px-8 text-center">
    <div class="max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold">Profil Penulis</h1>
      <p class="mt-4 text-lg md:text-xl">Temukan informasi tentang penulis dan karya-karya yang telah dipublikasikan.</p>
    </div>
  </section>
  ...
  <section class="py-16 px-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
      <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
        <!-- Profile Picture -->
        <img src="https://i.pinimg.com/736x/a8/0e/36/a80e3690318c08114011145fdcfa3ddb.jpg" alt="Foto Penulis" class="w-40 h-40 rounded-full shadow-md">
        <!-- Profile Info -->
        <div>
          <h2 class="text-3xl font-bold">Nama Penulis</h2>
          <p class="text-gray-600 mt-2">Penulis fiksi dan non-fiksi yang telah menerbitkan karya dalam berbagai genre. Memiliki pengalaman lebih dari 5 tahun dalam dunia penulisan.</p>
          <ul class="mt-4 text-gray-700 space-y-2">
            <li><strong>Email:</strong> penulis@gmail.com</li>
            <li><strong>Telepon:</strong> +620000000000</li>
            <li><strong>Lokasi:</strong> Malang, Indonesia</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-16 px-8 bg-gray-100">
    <div class="max-w-6xl mx-auto">
      <h2 class="text-3xl font-bold mb-6 text-center">Karya Publikasi</h2>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <!-- Single Work -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://i.pinimg.com/736x/8b/1c/4d/8b1c4da41f769189125f296d4ec4a9ea.jpg" alt="Karya 1" class="w-full h-40 object-cover rounded-lg">
          <h3 class="text-lg font-semibold mt-4">Judul Karya 1</h3>
          <p class="text-gray-600 mt-2">Deskripsi singkat tentang karya ini, menjelaskan tema dan ide utamanya.</p>
          <a href="#" class="mt-4 inline-block text-blue-600 hover:underline">Baca Selengkapnya</a>
        </div>
        <!-- Single Work -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://i.pinimg.com/736x/14/b6/70/14b670f183eb1a0ea98d5379f36edd86.jpg" alt="Karya 2" class="w-full h-40 object-cover rounded-lg">
          <h3 class="text-lg font-semibold mt-4">Judul Karya 2</h3>
          <p class="text-gray-600 mt-2">Deskripsi singkat tentang karya ini, menjelaskan tema dan ide utamanya.</p>
          <a href="#" class="mt-4 inline-block text-blue-600 hover:underline">Baca Selengkapnya</a>
        </div>
        <!-- Single Work -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://i.pinimg.com/736x/0c/58/5f/0c585ffe08d7a1c6894b9c9a00b3361d.jpg" alt="Karya 3" class="w-full h-40 object-cover rounded-lg">
          <h3 class="text-lg font-semibold mt-4">Judul Karya 3</h3>
          <p class="text-gray-600 mt-2">Deskripsi singkat tentang karya ini, menjelaskan tema dan ide utamanya.</p>
          <a href="#" class="mt-4 inline-block text-blue-600 hover:underline">Baca Selengkapnya</a>
        </div>
      </div>
  ...
  <section class="py-16 px-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
      <h2 class="text-3xl font-bold mb-6 text-center">Hubungi Penulis</h2>
      <form action="#" method="POST" class="space-y-6">
        <div>
          <label for="name" class="block text-gray-700 font-semibold">Nama</label>
          <input type="text" id="name" name="name" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:outline-none" placeholder="Nama Anda">
        </div>
        <div>
          <label for="email" class="block text-gray-700 font-semibold">Email</label>
          <input type="email" id="email" name="email" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:outline-none" placeholder="Email Anda">
        </div>
        <div>
          <label for="message" class="block text-gray-700 font-semibold">Pesan</label>
          <textarea id="message" name="message" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:outline-none" rows="4" placeholder="Pesan Anda"></textarea>
        </div>
        <button type="submit" class="w-full py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">Kirim Pesan</button>
      </form>
    </div>
  </section>
</div>
