...
<div class="min-h-full">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-8" src="img/logo_unspoken.png" alt="Your Company">
          </div>
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">About UnSpoken</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
  ...
  <section class="bg-blue-600 text-white py-16 px-8 text-center">
    <div class="max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold">Tentang Kami</h1>
      <p class="mt-4 text-lg md:text-xl">Membantu penulis berbakat untuk mengekspresikan ide mereka dan terhubung dengan pembaca di seluruh dunia.</p>
    </div>
  </section>
  ...
  <section class="py-16 px-8">
    <div class="max-w-5xl mx-auto text-center">
      ...
      <p class="text-gray-600 text-lg">
        Kami adalah tim kreatif yang percaya bahwa setiap ide layak untuk didengar. Platform kami dirancang untuk menjadi rumah bagi penulis fiksi dan non-fiksi dari berbagai latar belakang untuk berbagi cerita, belajar, dan tumbuh bersama.
      </p>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <p class="text-gray-600">
            Menjadi platform penulisan terkemuka yang mendukung kreativitas, membangun komunitas, dan menyebarkan ide-ide yang menginspirasi ke seluruh dunia.
          </p>
        </div>
        <!-- Mission -->
        <div class="bg-white p-6 rounded-lg shadow-md text-center">
          ...
          <ul class="text-gray-600 space-y-3 text-left">
            <li>- Menciptakan ruang yang mendukung eksplorasi dan kreativitas.</li>
            <li>- Menghubungkan penulis dengan pembaca dan komunitas.</li>
            <li>- Menyediakan alat dan sumber daya yang membantu penulis mencapai potensi terbaik mereka.</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <h3 class="text-xl font-semibold mb-2">Alat Tulis Canggih</h3>
          <p class="text-gray-600">Nikmati editor yang sederhana namun kuat untuk menulis karya tulismu dengan mudah.</p>
        </div>
        <!-- Feature 2 -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <div class="text-blue-600 text-4xl mb-4">
          ...
          <h3 class="text-xl font-semibold mb-2">Pengembangan Diri</h3>
          <p class="text-gray-600">Tumbuhkan kreatifitasmu, asah skill menulismu dan dapatkan apresiasi dari karya karyamu</p>
        </div>
        <!-- Feature 3 -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <div class="text-blue-600 text-4xl mb-4">
          ...
          <h3 class="text-xl font-semibold mb-2">Publikasi Mudah</h3>
          <p class="text-gray-600">Bagikan karya tulismu ke dunia dengan mudah melalui platform kami.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-16 px-8">
    <div class="max-w-5xl mx-auto text-center">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <!-- Team Member -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://i.pinimg.com/736x/64/ad/1e/64ad1e2d70440ca0719fdf6e2300afee.jpg" alt="Team Member" class="w-32 h-32 mx-auto rounded-full mb-4">
          <h3 class="text-lg font-bold">Azizah Istiqomah</h3>
        </div>

        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://via.placeholder.com/150" alt="Team Member" class="w-32 h-32 mx-auto rounded-full mb-4">
          <h3 class="text-lg font-bold">Iffah</h3>
        </div>

        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://via.placeholder.com/150" alt="Team Member" class="w-32 h-32 mx-auto rounded-full mb-4">
          <h3 class="text-lg font-bold">Asyifaul</h3>
        </div>

        <div class="bg-white p-6 rounded-lg shadow-md">
          <img src="https://via.placeholder.com/150" alt="Team Member" class="w-32 h-32 mx-auto rounded-full mb-4">
          <h3 class="text-lg font-bold">Adhini</h3>
        </div>
  </main>
