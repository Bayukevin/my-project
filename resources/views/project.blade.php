...
<div class="min-h-full">
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Welcome To Your Project</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
  ...
  <section class="bg-blue-600 text-white py-16 px-8 text-center">
    <div class="max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-bold">Manajemen Karya</h1>
      <p class="mt-4 text-lg md:text-xl">Kelola karya Anda dengan mudah. Edit, hapus, atau ubah status publikasi karya tulis Anda.</p>
    </div>
  </section>
  ...
  <section class="py-16 px-8">
    <div class="max-w-6xl mx-auto">
      <div class="space-y-16">
        <!-- Published Works -->
        <div>
          <h2 class="text-3xl font-bold mb-6">Karya Publikasi</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <!-- Single Work -->
            @foreach ($artikelsPublish as $artikel)
        ...
        <!-- Private Works -->
        <div>
          <h2 class="text-3xl font-bold mb-6">Karya Privat</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <!-- Single Work -->
            @foreach ($artikelsPrivate as $artikel)
                <div class="bg-white p-6 rounded-lg shadow-md">
                <img src="{{ asset('storage/' . $artikel->images) }}" alt="Karya 1" class="w-full h-40 object-cover rounded-lg">
                <h3 class="text-lg font-semibold mt-4">{{ $artikel->judul }}</h3>
                <p class="text-gray-600 mt-2">{{ $artikel->sub_judul }}</p>
                <div class="mt-4 flex justify-between items-center">
